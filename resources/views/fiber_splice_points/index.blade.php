...
@section('content')
    <div class="container-fluid">
            ...
            <div class="col">
                @can('transmission-create')
                    <div class="text-right">
                        <a href="{{route('fiber_splice_points.create')}}" class="btn btn-outline-success mb-2"><i
        ...
        <div class="card border-dark mb-3">
            <div class="card-header bg-gradient-primary font-weight-bold">Fiber Splice Points</div>
