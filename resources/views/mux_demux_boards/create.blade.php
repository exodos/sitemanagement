...
@section('content')
    ...
    <div class="container">
        <div class="card border-primary">
            <div class="card-header font-weight-bold bg-gradient-primary"><h3 class="mb-0">Create Mux Demux Board</h3>
            </div>
            <div class="card-body">
                @if($errors->any())
                ...
                @endif
                <form action="{{route('mux_demux_boards.store')}}" method="post">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="board_name"
                               name="board_name" value="{{request()->old('id')}}">
                    </div>
                    <div class="form-group">
