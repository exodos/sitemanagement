    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-4 col-xl-4">
                ...
                <form action="{{route('mux_demux_boards.index')}}" class="input-group" method="get">
                    <input type="text" class="form-control" name="search"
                           placeholder="Search By Board Id, Board Name Or Slot Number"
            ...
            <div class="col">
                @can('transmission-create')
                    <div class="text-right">
                        <a href="{{route('mux_demux_boards.create')}}" class="btn btn-outline-success mb-2"><i
        ...
        <div class="card border-dark mb-3">
            <div class="card-header bg-gradient-primary font-weight-bold">Mux Demux Board</div>
            <div class="card-body text-black-50">
                @if($muxDemuxBoards->isNotEmpty())
                    <table class="table table-bordered border-primary">
                        ...
                        @foreach($muxDemuxBoards as $muxDemuxBoard)
                            <tr>
                                ...
                                @can('transmission-edit')
                                    <td><a href="{{route('mux_demux_boards.edit', $muxDemuxBoard->id)}}"
                                           class="btn btn-primary btn-sm">Update</a></td>
                                @endcan
                                @can('transmission-delete')
                                    <td>
                                        <button class="btn btn-danger btn-sm"
                                                onclick="handleDelete({{$muxDemuxBoard->id}})">
                                            Delete
                                        </button>
                                    </td>
                                @endcan
                ...
                <div class="d-flex justify-content-center">
                    {!! $muxDemuxBoards->appends(['search' => request()->query('search')])->links() !!}
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-gradient-danger">
                            <h5 class="modal-title" id="deleteModalLabel">Delete Mux Demux Board</h5>
                        ...
                        <div class="modal-body">
                            <p class="text-center text-danger font-weight-bold">
                                Are You Sure You Want To Delete This Mux Demux Board Data ?
                            </p>
                        </div>
...
@section('scripts')
    <script>
        function handleDelete(id) {
            ...
            form.action = '/mux_demux_boards/' + id
