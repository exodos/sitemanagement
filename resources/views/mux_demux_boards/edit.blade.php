...
@section('sitemap')
    ...
    <li class="breadcrumb-item active"><a href="{{route('mux_demux_boards.index')}}">Index</a></li>
...
@section('content')
    ...
    <div class="container">
        <div class="card border-success">
            <div class="card-header font-weight-bold bg-gradient-primary"><h3 class="mb-0">Update Mux Demux Boards</h3>
            </div>
            <div class="card-body">
                @if($errors->any())
                ...
                @endif
                <form action="{{route('mux_demux_boards.update', isset($muxDemuxBoards)?$muxDemuxBoards->id:'')}}"
                      method="post">
                    @csrf
                    @method('put')
