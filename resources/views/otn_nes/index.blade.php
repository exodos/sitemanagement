    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-4 col-xl-4">
                ...
                <form action="{{route('otn_nes.index')}}" class="input-group" method="get">
                    <input type="text" class="form-control" name="search"
                           placeholder="Search By Ne Id, Name Or Type"
            ...
            <div class="col">
                @can('transmission-create')
                    <div class="text-right">
                        <a href="{{route('otn_nes.create')}}" class="btn btn-outline-primary mb-2"><i
        ...
        <div class="card border-dark mb-3">
            <div class="card-header bg-gradient-primary font-weight-bold">Ne</div>
            <div class="card-body text-black-50">
                @if($otnNes->isNotEmpty())
                    <table class="table table-bordered border-primary">
                        ...
                        @foreach($otnNes as $otnNe)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('otn_nes.show', $otnNe->id)}}"
                                       class="btn btn-success btn-sm">Detail</a>
                                </td>
                                @can('transmission-edit')
                                    <td><a href="{{route('otn_nes.edit', $otnNe->id)}}"
                                           class="btn btn-primary btn-sm">Update</a></td>
                                @endcan
                                @can('transmission-delete')
                                    <td>
                                        <button class="btn btn-danger btn-sm"
                                                onclick="handleDelete({{$otnNe->id}})">
                                            Delete
                                        </button>
                                    </td>
                                @endcan
                ...
                <div class="d-flex justify-content-center">
                    {!! $otnNes->appends(['search' => request()->query('search')])->links() !!}
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-gradient-danger">
                            <h5 class="modal-title" id="deleteModalLabel">Delete NE</h5>
                        ...
                        <div class="modal-body">
                            <p class="text-center text-danger font-weight-bold">
                                Are You Sure You Want To Delete This NE Data ?
                            </p>
                        </div>
