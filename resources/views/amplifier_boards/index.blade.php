...
{{--                <div class="sidebar px-4 py-md-0">--}}
                    <form action="{{route('amplifier_boards.index')}}" class="input-group" method="get">
                        <input type="text" class="form-control" name="search"
                               placeholder="Search By Amplifier Boards Board Id Or Board Name"
...
{{--                </div>--}}
            ...
            <div class="col">
                @can('transmission-create')
                    <div class="text-right">
                        <a href="{{route('amplifier_boards.create')}}" class="btn btn-outline-success mb-2"><i
        ...
        <div class="card border-dark mb-3">
            <div class="card-header bg-gradient-primary font-weight-bold">Amplifier Boards</div>
            <div class="card-body text-black-50">
                @if($amplifierBoards->isNotEmpty())
                    <table class="table table-bordered border-primary">
                        ...
                        @foreach($amplifierBoards as $amplifierBoard)
                            <tr>
                                ...
                                @can('transmission-edit')
                                    <td><a href="{{route('amplifier_boards.edit', $amplifierBoard->id)}}"
                                           class="btn btn-primary btn-sm">Update</a></td>
                                @endcan
                                @can('transmission-delete')
                                    <td>
                                        <button class="btn btn-danger btn-sm"
                                                onclick="handleDelete({{$amplifierBoard->id}})">
                                            Delete
                                        </button>
                                    </td>
                                @endcan
                ...
                <div class="d-flex justify-content-center">
                    {!! $amplifierBoards->appends(['search' => request()->query('search')])->links() !!}
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-gradient-danger">
                            <h5 class="modal-title" id="deleteModalLabel">Delete Amplifier Board</h5>
                        ...
                        <div class="modal-body">
                            <p class="text-center text-danger font-weight-bold">
                                Are You Sure You Want To Delete This Amplifier Board Data ?
                            </p>
                        </div>
...
@section('scripts')
    <script>
        function handleDelete(id) {
            ...
            form.action = '/amplifier_boards/' + id
