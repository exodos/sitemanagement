    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-4 col-xl-4">
                ...
                <form action="{{route('line_boards.index')}}" class="input-group" method="get">
                    <input type="text" class="form-control" name="search"
                           placeholder="Search By Line Board Id, Board Name Or Slot Number"
            ...
            <div class="col">
                @can('transmission-create')
                    <div class="text-right">
                        <a href="{{route('line_boards.create')}}" class="btn btn-outline-success mb-2"><i
        ...
        <div class="card border-dark mb-3">
            <div class="card-header bg-gradient-primary font-weight-bold">Line Board</div>
            <div class="card-body text-black-50">
                @if($lineBoards->isNotEmpty())
                    <table class="table table-bordered border-primary">
                        ...
                        @foreach($lineBoards as $lineBoard)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('line_boards.show', $lineBoard->id)}}"
                                       class="btn btn-success btn-sm">Detail</a>
                                </td>
                                @can('transmission-edit')
                                    <td><a href="{{route('line_boards.edit', $lineBoard->id)}}"
                                           class="btn btn-primary btn-sm">Update</a></td>
                                @endcan
                                @can('transmission-delete')
                                    <td>
                                        <button class="btn btn-danger btn-sm"
                                                onclick="handleDelete({{$lineBoard->id}})">
                                            Delete
                                        </button>
                                    </td>
                                @endcan
                ...
                <div class="d-flex justify-content-center">
                    {!! $lineBoards->appends(['search' => request()->query('search')])->links() !!}
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header bg-gradient-danger">
                            <h5 class="modal-title" id="deleteModalLabel">Delete Line Board</h5>
                        ...
                        <div class="modal-body">
                            <p class="text-center text-danger font-weight-bold">
                                Are You Sure You Want To Delete This Line Boards Data ?
                            </p>
                        </div>
