...
@section('content')
    ...
    <div class="container">
        <div class="card border-primary">
            <div class="card-header font-weight-bold bg-gradient-primary"><h3 class="mb-0">Create Line Boards</h3>
            </div>
            <div class="card-body">
                @if($errors->any())
                ...
                @endif
                <form action="{{route('line_boards.store')}}" method="post">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="slot_number"
                               name="slot_number" value="{{request()->old('')}}">
                    </div>
                    <div class="form-group">
                        <label for="port_capacity">Port Capacity</label>
                        <input type="text" class="form-control" id="port_capacity"
