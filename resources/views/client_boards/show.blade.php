...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card border-primary mb-3">
            <div class="card-header bg-gradient-primary font-weight-bold">Client Board Details</div>
        ...
        @if($clientBoards->transmission_otn_service->isNotEmpty())
            <div class="card border-success mb-3">
                <div class="card-header bg-gradient-primary font-weight-bold">OTn Services Details</div>
                <div class="card-body text-black-50">
                    <table class="table table-bordered">
                        <thead>
                        <tr class="bg-gradient-success">
