                ...
                <div class="user-panel mt-2 d-flex">
                    <div class="info">
                        <a href="" class="d-block" data-toggle="modal"
                           data-target="#ModalLoginForm">{{Auth()->user()->name}}</a>
                    </div>
                </div>
        @endif
            ...
            @if (Auth()->check())
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-4">{{auth()->user()->name}}
                        </div>
                    </div>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-4">
                            <i class="fas fa-mobile-alt fa-3x" style="color: #0c84ff"></i>
                        </div>
                        <div class="col-4">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-4">
                            <i class="fab fa-r-project fa-3x" style="color: #0c84ff"></i>
                        </div>
                        <div class="col-4">
