...
@section('content')
    <div class="container-fluid">
        <div class="text-right">
            <a href="{{route('workorders.index')}}" class="btn btn-outline-dark mb-1"><i
                    class="fas fa-caret-left fa-2x"></i></a>
        </div>
        <div class="card border-success mb-3">
            <div class="card-header bg-gradient-primary font-weight-bold">Work Order Details</div>
            <div class="card-body text-black-50">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <th scope="row">{{ $workOrders->id }}</th>
                            <td>{{ $workOrders->work_orders_number }}</td>
                            <td>{{ $workOrders->created_at->format('Y-m-d') }}</td>
                            <td>{{ $workOrders->updated_at->format('Y-m-d') }}</td>
                    </tr>
        ...
        @if($workOrders->sites->isNotEmpty())
            <div class="card border-success mb-3">
                ...
                <div class="card-body text-black-50">
                    <table class="table table-bordered table-responsive">
                        ...
                        <tbody>
                        @foreach($workOrders->sites as $site)
                            <tr>
        ...
        @endif
        @if($workOrders->air_conditioners->isNotEmpty())
            <div class="card border-success mb-3">
                ...
                <div class="card-body text-black-50">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                        @foreach($workOrders->air_conditioners as $airconditioner)
                            <tr>
        ...
        @endif
        @if($workOrders->batteries->isNotEmpty())
            <div class="card border-success mb-3">
                ...
                <div class="card-body text-black-50">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                        @foreach($workOrders->batteries as $battery)
                            <tr>
        ...
        @endif
        @if($workOrders->powers->isNotEmpty())
            <div class="card border-success mb-3">
                <div class="card-header bg-gradient-primary font-weight-bold">Generator Details</div>
                <div class="card-body text-black-50">
                    <table class="table table-bordered table-responsive">
                        <thead>
                        <tr class="bg-gradient-success">
                        ...
                        <tbody>
                        @foreach($workOrders->powers as $power)
                            <tr>
        ...
        @endif
        @if($workOrders->rectifiers->isNotEmpty())
            <div class="card border-success mb-3">
                ...
                <div class="card-body text-black-50">
                    <table class="table table-bordered table-responsive">
                        ...
                        <tbody>
                        @foreach($workOrders->rectifiers as $rectifier)
                            <tr>
        ...
        @endif
        @if($workOrders->solar_panels->isNotEmpty())
            <div class="card border-success mb-3">
                ...
                <div class="card-body text-black-50">
                    <table class="table table-bordered">
                        ...
                        <tbody>
                        @foreach($workOrders->solar_panels as $solarpanel)
                            <tr>
        ...
        @endif
        @if($workOrders->towers->isNotEmpty())
            <div class="card border-success mb-3">
                ...
                <div class="card-body text-black-50">
                    <table class="table table-bordered table-responsive">
                        ...
                        <tbody>
                        @foreach($workOrders->towers as $tower)
                            <tr>
        ...
        @endif
        <div class="text-right">
            <a href="{{route('workorders.index')}}" class="btn btn-outline-dark btn-lg nav-item mb-2"><i
                    class="fas fa-caret-left fa-2x"></i></a>
        </div>
    </div>
@endsection
