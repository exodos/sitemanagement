...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card border-primary mb-3">
            <div class="card-header bg-gradient-primary font-weight-bold">Transmission Site Details</div>
        ...
        @if($transmissionSite->transmission_client_board->isNotEmpty())
            <div class="card border-success mb-3">
                <div class="card-header bg-gradient-primary font-weight-bold">Client Boards Details</div>
                <div class="card-body text-black-50">
                    <table class="table table-bordered">
                        <thead>
                        <tr class="bg-gradient-success">
        ...
        @if($transmissionSite->transmission_mux_demux_board->isNotEmpty())
            <div class="card border-success mb-3">
                <div class="card-header bg-gradient-primary font-weight-bold">Mux Demux Board Details</div>
                <div class="card-body text-black-50">
                    <table class="table table-bordered">
                        <thead>
                        <tr class="bg-gradient-success">
        ...
        @if($transmissionSite->transmission_otn_service->isNotEmpty())
            <div class="card border-success mb-3">
                <div class="card-header bg-gradient-primary font-weight-bold">OTN Service Details</div>
                <div class="card-body text-black-50">
                    <table class="table table-bordered">
                        <thead>
                        <tr class="bg-gradient-success">
        ...
        @if($transmissionSite->transmission_roadm_board->isNotEmpty())
            <div class="card border-success mb-3">
                <div class="card-header bg-gradient-primary font-weight-bold">Roadm Board Details</div>
                <div class="card-body text-black-50">
                    <table class="table table-bordered">
                        <thead>
                        <tr class="bg-gradient-success">
        ...
        @if($transmissionSite->microwaves->isNotEmpty())
            <div class="card border-success mb-3">
                <div class="card-header bg-gradient-primary font-weight-bold">Microwaves Details</div>
                <div class="card-body text-black-50">
                    <table class="table table-bordered">
                        <thead>
                        <tr class="bg-gradient-success">
