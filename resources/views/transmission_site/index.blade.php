...
@section('content')
    <div class="container-fluid">
            ...
            <div class="col">
                @can('transmission-create')
                    <div class="text-right">
                        <a href="{{route('transmission_site.create')}}" class="btn btn-outline-success mb-2"><i
        ...
        <div class="card border-dark mb-3">
            <div class="card-header bg-gradient-primary font-weight-bold">Transmission Site Information</div>
