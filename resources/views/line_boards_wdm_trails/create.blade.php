...
@section('content')
    ...
    <div class="container">
        <div class="card border-primary">
            <div class="card-header font-weight-bold bg-gradient-primary"><h3 class="mb-0">Create Line Board Wdm Trails</h3>
            </div>
            <div class="card-body">
                @if($errors->any())
                ...
                @endif
                <form action="{{route('line_boards_wdm_trails.store')}}" method="post">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="trail_name"
                               name="trail_name" value="{{request()->old('trail_name')}}">
                    </div>
                    <div class="form-group">
                        <label for="working_mode">Working Mode</label>
                        <input type="text" class="form-control" id="working_mode"
                               name="working_mode" value="{{request()->old('working_mode')}}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="source_port_wave_length"
                               name="source_port_wave_length" value="{{request()->old('source_port_wave_length')}}" step="0.01">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="sink_port_wave_length"
                               name="sink_port_wave_length" value="{{request()->old('sink_port_wave_length')}}" step="0.01">
                    </div>
                    <div class="form-group">
