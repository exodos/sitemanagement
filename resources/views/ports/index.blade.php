    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-4 col-xl-4">
                ...
                <form action="{{route('ports.index')}}" class="input-group" method="get">
                    <input type="text" class="form-control" name="search"
                           placeholder="Search By Ports Id, Name Or Device Role">
        ...
        <div class="card border-dark mb-3">
            <div class="card-header bg-gradient-primary font-weight-bold">Ports</div>
            <div class="card-body text-black-50">
                    ...
                    <table class="table table-bordered border-primary">
                        ...
                        @foreach($ports as $port)
                            <tr>
                                ...
                                @can('network-edit')
                                    <td><a href="{{route('ports.edit', $port->id)}}"
                ...
                <div class="d-flex justify-content-center">
                    {!! $ports->appends(['search' => request()->query('search')])->links() !!}
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p class="text-center text-danger font-weight-bold">
                                Are You Sure You Want To Delete This Port Usage Data ?
                            </p>
                        </div>
